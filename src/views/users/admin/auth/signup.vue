<template>
    <div class="login w-full h-fit flex items-center justify-center sm:justify-between my-[8%] sm:my[10%] lg:my-0">
        <div
            class="w-11/12 md:w-9/12 lg:w-5/12 pt-6 m-auto border-2 border-[#c9c9c9] px-6 rounded shadow-sm shadow-gray-200">
            <!-- rounded-xl m-auto px-6 bg-white 
            lg:bg-none shadow-md lg:shadow-none shadow-gray-300 pt-8"> -->
            <div class="flex items-center gap-2">
                <router-link to="/shop.co/home" class="flex items-center gap-2 ">
            ...
            <form class="inputs my-4 font-semibold font-sans capitalize flex flex-wrap" @submit.prevent="register">
                ...
                <div class="w-full flex flex-wrap justify-between">
                    <div class="w-full sm:w-[49%]">
                        ...
                        <input v-model="firstname" placeholder="Enter first name"
                            class="outline-none bg-gray-100 w-full my-1 p-2 sm:p-3 border-2 font-normal rounded-md text-sm sm:text-md">
                    </div>
                ...
                <div class="w-full flex flex-wrap justify-between">
                    ...
                    <div class="w-full sm:w-[49%] mt-2 sm:mt-0">
                        ...
                        <select id="country" class="outline-none bg-gray-100 w-full my-1 p-2 sm:p-3 border-2
                            font-normal rounded-md text-sm sm:text-md capitalize">
                            ...
                            <option class="capitalize font-normal hover:bg-gray-200" value="UAE">UAE</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="w-full flex flex-wrap justify-between">
                    ...
                    <div class="w-full sm:w-[49%] mt-2 sm:mt-0">
                        ...
                        <input type="text" v-model="location" placeholder="Enter shop location"
                            class="outline-none bg-gray-100 w-full my-1 p-2 sm:p-3 border-2 rounded-md text-sm sm:text-md">
                    </div>
                </div>
                ...
                <div class="w-full">
                    <BaseButton :disabled="!isValidForm" type="submit" class="w-full mt-5">
                        register
                    </BaseButton>
                </div>
            </form>
